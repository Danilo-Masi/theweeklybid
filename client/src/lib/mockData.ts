...
export const mockSlots: AdSlot[] = [
    {
        ...
        description: 'Etiam ipsum ante, consequat eleifend sodales eu, commodo sit amet massa. Cras dictum nisi vel fringilla dapibus. Nullam hendrerit dapibus orci. Curabitur erat nunc, lacinia sit amet lectus id',
    ...
    ...Array.from({ length: 6 }).map((_, i) => ({
        ...
        description: "Nam vestibulum congue nulla, sit amet placerat ex rutrum at. Duis sollicitudin ligula sit amet pellentesque scelerisque.",
